...
/**
 * QueryFrame creates a GUI for use with QueryRunner. It contains buttons
 * and a menu to allow a user to connect to the database and run predefined
 * queries.
 * The original version has been enhanced to include query names on the
 * drop down menu. The feature to allow a user to save query results to csv
 * file has also been added.
 *
 * @author mckeem
 */
...
public class QueryFrame extends javax.swing.JFrame
{
   ...
   private void initComponents()
   {
      ...
      jPanel1.add(jLabel1,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 29, 132, -1));
      ...
      jPanel1.add(jLabel4,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 65, 132, 18));
      ...
      getContentPane().add(jLabel5,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 90, 10));
      ...
      getContentPane().add(jLabel7,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 100, -1));

      jLabel8.setText("Password");
      getContentPane().add(jLabel8,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 80, -1));
      ...
      getContentPane().add(jLabel14,
            new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 10, 180,
                  -1));
    ...
    * that it will eventually pass to the ExecuteQuery function.
    * 
    * If it is a query that returns a resultset, it will create a JTABLE which
    * is a GUI Control that enables the resultset data to transferred to it.
    * 
   ...
   private void buttonExportCSVActionPerformed(java.awt.event.ActionEvent evt)
   {
      ...
      try
      {
         ...
         jTextArea2.setText(
               "Query results have been exported to CSV file:\n" + csvFilename);
